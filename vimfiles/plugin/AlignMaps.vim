...
if has("menu") && has("gui_running") && &go =~ 'm' && !exists("s:firstmenu")
 ...
 if g:DrChipTopLvlMenu != ""
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.<<\ and\ >><Tab>\\a<	<Leader>a<'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Assignment\ =<Tab>\\t=	<Leader>t='
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Assignment\ :=<Tab>\\a=	<Leader>a='
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Backslashes<Tab>\\tml	<Leader>tml'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Breakup\ Comma\ Declarations<Tab>\\a,	<Leader>a,'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.C\ Comment\ Box<Tab>\\abox	<Leader>abox'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Commas<Tab>\\t,	<Leader>t,'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Commas<Tab>\\ts,	<Leader>ts,'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Commas\ With\ Strings<Tab>\\tsq	<Leader>tsq'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Comments<Tab>\\acom	<Leader>acom'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Comments\ Only<Tab>\\aocom	<Leader>aocom'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Declaration\ Comments<Tab>\\adcom	<Leader>adcom'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Declarations<Tab>\\adec	<Leader>adec'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Definitions<Tab>\\adef	<Leader>adef'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Function\ Header<Tab>\\afnc	<Leader>afnc'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Html\ Tables<Tab>\\Htd	<Leader>Htd'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.(\.\.\.)?\.\.\.\ :\ \.\.\.<Tab>\\a?	<Leader>a?'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Numbers<Tab>\\anum	<Leader>anum'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Numbers\ (American-Style)<Tab>\\aunum	<Leader>aunum	<Leader>aunum	<Leader>aunum'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Numbers\ (Euro-Style)<Tab>\\aenum	<Leader>aenum'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Spaces\ (Left\ Justified)<Tab>\\tsp	<Leader>tsp'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Spaces\ (Right\ Justified)<Tab>\\Tsp	<Leader>Tsp'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Statements\ With\ Percent\ Style\ Comments<Tab>\\m=	<Leader>m='
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Symbol\ <<Tab>\\t<	<Leader>t<'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Symbol\ \|<Tab>\\t\|	<Leader>t|'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Symbol\ @<Tab>\\t@	<Leader>t@'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Symbol\ #<Tab>\\t#	<Leader>t#'
  exe 'menu '.g:DrChipTopLvlMenu.'&AlignMaps.Tabs<Tab>\\tab	<Leader>tab'
 endif
endif
